def start_game(player):
    ...
    #нужно получить множество названий файлов те {1,2,3...}
    #затем через random выбрать один из файлов. Или мб просто shaffle сделать?
    # из файла нужно выгрузить данные по разным переменным
    # вопрос
    # ответы
    # верный ответ
